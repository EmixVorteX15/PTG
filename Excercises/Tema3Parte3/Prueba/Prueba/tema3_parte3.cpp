...
GLuint locTexture, locGloss, locParallax;
...
GLboolean init()
{
	...
	loadSource(vertexShaderID, "shaders/tema3_parte3.vert");
	glCompileShader(vertexShaderID);
	printCompileInfoLog(vertexShaderID);
	glAttachShader(programID, vertexShaderID);

	GLuint fragmentShaderID = glCreateShader(GL_FRAGMENT_SHADER);
	loadSource(fragmentShaderID, "shaders/tema3_parte3.frag");
	...
	//Booleanos
	locTexture = glGetUniformLocation(programID, "uTexture");	// C -> Textura
	locGloss = glGetUniformLocation(programID, "uGloss");		// B -> Brillo
	locParallax = glGetUniformLocation(programID, "uParallax");		// P -> Parallax
	...
	const GLchar img_filename_normalmap[] = "texturas/brick_normal.png";
	const GLchar img_filename_colormap[] = "texturas/brick_color.png";
	const GLchar img_filename_heightmap[] = "texturas/brick_height.png";
	const GLchar img_filename_glossmap[] = "texturas/brick_gloss.png";
/*	
...
*/
	...
	/*
	// Idem para colormap, heightmap y glossmap
	*/
	return true;
}
...
void display()
{
	...
	glUniform1i(locTexture, texture);			//Si se dibuja textura o material
	glUniform1i(locGloss, gloss);				//Si aplica gloss
	glUniform1i(locParallax, parallax);				//Si aplica gloss
	// ...
