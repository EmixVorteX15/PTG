...
GLuint sombreadoSuave = 2;
GLboolean luzFoco = false;
GLboolean green = false;
GLboolean dither = false;
...
GLuint objVAOHandle, cubeVAOHandle, sphereVAOHandle, teapotVAOHandle, planeVAOHandle, torusVAOHandle;
GLuint programID, programID2, programID3;
GLuint locUniformMVPM, locUniformMVM, locUniformNM, locUniformCamera;
...
GLuint locUniformColorBrightest, locUniformColorBright, locUniformColorDark, locUniformColorDarkest;
GLboolean locUniformSuavizado, locUniformLuzFoc;

int numVertObj, numVertTeapot, numVertSphere, numVertPlane, numVertTorus;
...
GLboolean init()
{
	...
	loadSource(fragmentShaderID, "shaders/tema3_parte2.frag");
	...
	loadSource(fragmentShaderID2, "shaders/tema3_parte2_green.frag");
	std::cout << "Compilando shader de fragmento verde ..." << std::endl;
	...
	loadSource(fragmentShaderID3, "shaders/dithering.frag");
	std::cout << "Compilando shader de fragmento dither ..." << std::endl;
	...
	locUniformColorBrightest = glGetUniformLocation(programID, "uColor.brightest");
	locUniformColorBright = glGetUniformLocation(programID, "uColor.bright");
	locUniformColorDark = glGetUniformLocation(programID, "uColor.dark");
	locUniformColorDarkest = glGetUniformLocation(programID, "uColor.darkest");

	// Booleans
	locUniformSuavizado = glGetUniformLocation(programID, "sombreadoSuave");
	locUniformLuzFoc = glGetUniformLocation(programID, "luzFoco");
...
void display()
{
	...
	ColorInfo hollowKnight = { glm::vec3(0.914f,0.902f,0.91f), glm::vec3(0.678,0.094,0.243) ,glm::vec3(0.463,0.486,0.682) ,glm::vec3(0.,0.024,0.024) };
	ColorInfo spidey = { glm::vec3(0.,0.024,0.024),glm::vec3(0.678,0.094,0.243),glm::vec3(0.004,0.125,0.439) ,glm::vec3(0.008,0.263,0.91) };
	ColorInfo cosmic_spidey = { glm::vec3(0.,0.024,0.024),glm::vec3(0.678,0.094,0.243),glm::vec3(0.004,0.125,0.439) ,glm::vec3(0.008,0.263,0.91) };
	ColorInfo spidey_last = { glm::vec3(0.788,0.969,0.51),glm::vec3(0.427,0.757,0.635),glm::vec3(0.075,0.337,0.498) ,glm::vec3(0.008,0.263,0.91) };
	//ColorInfo hollowKnight = { glm::vec3(0.98f,0.984f,0.965f), glm::vec3(0.776f,0.718f,0.745f) ,glm::vec3(0.337f,0.353f,0.459f) ,glm::vec3(0.059f,0.059f,0.106f) };
	...
	MaterialInfo perl = {glm::vec3(0.25f, 0.20725f, 0.20725f), glm::vec3(1.0f, 0.829f, 0.829f), glm::vec3(0.296648f, 0.296648f, 0.296648f), 0.0f};
	...
	glUniform1i(locUniformLuzFoc, luzFoco);
	...
	// Colores Hollow Knight
	glUniform3fv(locUniformColorBrightest, 1, &(hollowKnight.brightest.x));
	glUniform3fv(locUniformColorBright, 1, &(hollowKnight.bright.x));
	glUniform3fv(locUniformColorDark, 1, &(hollowKnight.dark.x));
	glUniform3fv(locUniformColorDarkest, 1, &(hollowKnight.darkest.x));
	if (green)
	{
		glUniform3fv(locUniformColorBrightest, 1, &(spidey_last.brightest.x));
		glUniform3fv(locUniformColorBright, 1, &(spidey_last.bright.x));
		glUniform3fv(locUniformColorDark, 1, &(spidey_last.dark.x));
		glUniform3fv(locUniformColorDarkest, 1, &(spidey_last.darkest.x));
	}
	else
	{
		glUniform3fv(locUniformColorBrightest, 1, &(spidey.brightest.x));
		glUniform3fv(locUniformColorBright, 1, &(spidey.bright.x));
		glUniform3fv(locUniformColorDark, 1, &(spidey.dark.x));
		glUniform3fv(locUniformColorDarkest, 1, &(spidey.darkest.x));
	}
